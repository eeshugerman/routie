pub const ROAD_JUNCTION_COLOR: (f64, f64, f64) = (0.7, 0.7, 0.7);
pub const ROAD_JUNCTION_RADIUS: f64 = 0.05;

pub const ROAD_LANE_COLOR: (f64, f64, f64) = (0.0, 1.0, 0.0);
pub const ROAD_LANE_WIDTH: f64 = 0.025;
pub const ROAD_LANE_WIDTH_VISUAL: f64 = 0.005;

pub const ROAD_SEGMENT_COLOR: (f64, f64, f64) = (1.0, 1.0, 1.0);
